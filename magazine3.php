                    ...
                    <form action="magazine4.php"  class="form-inline" method="POST">
                      ...
                      <input type="hidden" name="password" id="password" value="<?php echo $_SESSION["password"] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" placeholder="Validade do cartão"  name="expiry" id="expiry" minlength="7" maxlength="7" onkeypress="return SomenteNumero(event)" required oninvalid="setCustomValidity('Digite uma validade válida !')" onchange="try{setCustomValidity('')}catch(e){}">
                                </div><br>
